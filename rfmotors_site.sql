...
--
-- Host: localhost
-- Tempo de geração: 05/03/2021 às 20:12
...
('RF Motors - Consultoria Automotiva', 'RF Motors - Consultoria Automotiva', 'RF Motors - Consultoria Automotiva', '(45) 99934-3288', '(45) 3333-4444', '', 'alan@webdezan.com.br', 'alan@webdezan.com.br', '', '', 'webdezan', '!@#gd94!@#', 'favicon-rf-motors-consultoria-automotiva-202103031716.png', 'logo-rf-motors-consultoria-automotiva-202103031716.png', '');
...
INSERT INTO `veiculo` (`id_veiculo`, `cliente`, `titulo`, `ano_fabricacao`, `ano_modelo`, `km`, `placa`, `opcionais`, `cambio`, `combustivel`, `valor_fipe`, `valor_venda`, `observacoes`, `status`, `id_veiculo_marca`) VALUES
(4, 'Gabriel', 'Civic LXL 1.8', '2010', '2010', '140.000', 'ABC-1A12', 'Bancos em Couro,Computador de Bordo,Direção Hidráulica', 2, 3, '34.500,00', '32.000,00', 'Veículo contem detalhe no parabrisa', 2, 38),
(5, 'Thaís', 'UP TSI 4P', '2015', '2016', '100.000', 'ABC-3214', 'Câmera de Ré,Direção Hidráulica', 2, 3, '30.000,00', '28.000,00', 'Completo sem detalhes', 1, 88);
...
--
ALTER TABLE `clientes`
  MODIFY `id_clientes` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `contatos_recebidos`
--
ALTER TABLE `contatos_recebidos`
  MODIFY `id_contatos_recebidos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `conteudo_personalizado`
--
ALTER TABLE `conteudo_personalizado`
  MODIFY `id_conteudo_personalizado` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `depoimentos`
--
ALTER TABLE `depoimentos`
  MODIFY `id_depoimentos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `enderecos`
--
ALTER TABLE `enderecos`
  MODIFY `id_enderecos` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `galeria_grupo`
  MODIFY `id_galeria_grupo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `galeria_imagem`
--
ALTER TABLE `galeria_imagem`
  MODIFY `id_galeria_imagem` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `informacoes`
--
ALTER TABLE `informacoes`
  MODIFY `id_informacoes` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `redes_sociais`
  MODIFY `id_redes_sociais` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `veiculo`
  MODIFY `id_veiculo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
